...
def test_tether_client_service_account_always_use_jwt_true(transport_class, transport_name):
    with mock.patch.object(service_account.Credentials, 'with_always_use_jwt_access', create=True) as use_jwt:
        creds = service_account.Credentials(None, None, None)
...
def test_tether_client_client_options_credentials_file(client_class, transport_class, transport_name):
...
def test_tether_grpc_transport_client_cert_source_for_mtls(
    transport_class
):
...
@pytest.mark.parametrize("transport_class", [transports.TetherGrpcTransport, transports.TetherGrpcAsyncIOTransport])
def test_tether_transport_channel_mtls_with_client_cert_source(
    transport_class
):
...
# removed from grpc/grpc_asyncio transport constructor.
@pytest.mark.parametrize("transport_class", [transports.TetherGrpcTransport, transports.TetherGrpcAsyncIOTransport])
def test_tether_transport_channel_mtls_with_adc(
    transport_class
):
    mock_ssl_cred = mock.Mock()
